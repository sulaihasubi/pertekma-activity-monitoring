            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">List of Activity Log:<?php $queryproposal=mysqli_query($con, "SELECT * FROM proposal WHERE proposald='$proposalId'"); 
						...
						<table class="table table-bordered" id="" width="100%" cellspacing="0">
						  ...
						  <tbody> 
							<?php 
							  ...
							  <td>
                                 <textarea rows="3" readonly name="prologdetail[]" value="<?php echo $col["advisor_comment"]; ?>" class="form-control-plaintext"></textarea>
                              </td>
							  </tr>
                                	<?php
                                 }
