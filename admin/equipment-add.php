...
if(isset($_POST['submitin'])){
	  ...
	  $Idequipment=$_GET["equipmentId"];
	//counter
	for($i=0;$i<count($prokeperluan);$i++){
		// condition where each item must met
		if($prokeperluan!="" && $prokuantiti[$i]!="" ){
			// if all of the condition met
			mysqli_query($con, "INSERT INTO equipmentdetail (idequipment, keperluan, kuantiti, unit, catatan) VALUES('$Idequipment', '$prokeperluan[$i]','$prokuantiti[$i]', '$prounit[$i]','$procatatan[$i]')");
			//header("Location: equipment-view.php=".$proposalId."&equipmentId=".$Idequipment);
			header('Location:equipment-view.php?id='.$proposalId.'&equipmentId='.$Idequipment);
  		}else{
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> Manage Equipments and Requirements</h1> 
          </div>
          ...
          <div id="page-wrapper">
           <div class="card-body">
            ...
            <div class="row">
               <div class="col-md-3 col-lg-12">
                    <div class="form-group">
                      <label class="control-label"><b>11.0 Senarai Keperluan/Peralatan</b></label>
                    </div>
                 </div>
                <div class="col-lg-12">
                	<div class="controls">
                		...
                		<div class="entry input-group">
							<div class="col-lg-12">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="" name="prokeperluan[]" class="form-control" id="inputkeperluan" placeholder="">
									</div>
								</div>
								<div class="form-group row">
									<label for="inputPassword3" class="col-sm-2 col-form-label">Kuantiti</label>
									<div class="col-sm-10">
										<input type="" name="prokuantiti[]" class="form-control" id="inputkuantiti" placeholder="">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<select name="prounit[]" class="form-control col-sm-10">
										   ...
										   <option value="Keselamatan">Keselamatan</option>
										    ...
										    <option value="Perhubungan Luar">Perhubungan Luar</option>
										    </select>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="" name="procatatan[]" class="form-control" id="inputcatatan" placeholder="">
									</div>
								</div>
							</div>
            ...
            <input type="hidden" name="idequipment" value="<?php echo $rowequipmentdetail ["idequipment"]; ?>">	
           </div>
