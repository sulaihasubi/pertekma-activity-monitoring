...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
        <a class="nav-link" href="activityPosmortem.php">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Program or Activity Details</h1> 
          </div>
            ...
            <div class="row">            
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">7.0 Perincian Program</h6>
					</div>
					<div class="container">
					  <p></p>
						<table class="table table-bordered"  width="100%" cellspacing="0">
						  ...
						  <tbody>
							<?php 
							$activity=mysqli_query($con, "SELECT * FROM activity a JOIN org_detail b ON a.ketuaUnit=b.idOrg_detail WHERE a.proposaId='$proposalId'");
							  while($col = mysqli_fetch_array($activity)){
								  $Title=$col["activityTitle"];
								  $Objective=$col["objective"];
								  $Nama=$col["nama"];
							?>
							<tr>
							  <td><?php echo $Title; ?></td>
							  <td style="text-align: justify;"><?php echo $Objective; ?></td>
							  <td>
								  <a href="#" class="" data-toggle="modal" data-target="#editActivity<?php echo $col["activityId"]; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Activity"></span></a>
								  
								  <a href="#" class="" data-toggle="modal" data-target="#viewActivity<?php echo $col["activityId"]; ?>"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="View Activity"></span></a>
								  
								  <a href="#" class="" data-toggle="modal" data-target="#deleteActivity<?php echo $col["activityId"]; ?>"><span class="btn btn-danger btn-xs fa fa-trash-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Activity"></span></a>
       ...
       <div class="form-group row">
		...
		<div class="col-lg-12">
			<div style="float: right;">
				<a class="btn btn-success btn-lg" href="proposal-add.php?id=<?php echo $proposalId; ?>" id="btnBack"><i class="fa fa-backward"></i> Back</a>
				<a class="btn btn-success btn-lg" href="activity2-tentative.php?id=<?php echo $proposalId; ?>" id="btnNext"><i class="fa fa-save"></i> Next</a>
