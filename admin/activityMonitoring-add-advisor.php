						...
						<table class="table table-bordered" width="100%" cellspacing="0">
						  ...
						  <tbody> 
							<?php 
							  ...
							  <td>
                                 <textarea rows="3" name="advisor_comment[]" class="form-control"><?php $queryExco=mysqli_query($con, "SELECT * FROM activityMonitoring WHERE id_proposal='$proposalId'");
						$rowUsername=mysqli_fetch_array($queryExco);
						echo $rowUsername["advisor_comment"];
						?></textarea>
                              </td>
							  </tr>
                                	<?php
