            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">List of Exco's Activity Log</h6>
					</div>
					<div class="container">
				  		<p></p>
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td style="text-align: justify;"><?php 
								  ...
								  ?></td>
							  <td>
								  <a href="activityMonitoring-add-advisor.php?id=<?php echo $proposalId; ?>&amp;username=<?php echo $Jawatan; ?>" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Monitor Exco"></span></a>
