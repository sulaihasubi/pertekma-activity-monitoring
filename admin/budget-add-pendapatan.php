...
if(isset($_POST['submitin'])){
	...
	for($i=0;$i<count($properkara);$i++){
		...
		if($properkara!="" && $prohargaSeunit[$i]!="" && $prokuantiti[$i]!=""){
			...
			mysqli_query($con, "INSERT INTO b_income (Iproposald, perkara, hargaSeunit, kuantiti, jumlah) VALUES('$proposalId', '$properkara[$i]','$prohargaSeunit[$i]','$prokuantiti[$i]','$jumlah[$i]')");	
			header('Location:budget-view-pendapatan.php?id='.$proposalId);
  		}else{
           ...
           <div class="card-body">
            ...
            <div class="row">
               <div class="col-md-3 col-lg-12">
                 ...
                 <div class="col-md-3 col-lg-12">
                    <div class="form-group">
                      <label class="control-label"><em>a) Anggaran Pendapatan</em></label>
                    </div>
                 </div>
                <div class="col-lg-12">
                	<div class="controls">
