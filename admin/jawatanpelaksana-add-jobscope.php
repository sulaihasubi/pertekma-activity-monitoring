...
<?php
$proposalId=$_GET["id"];
$idOrg_detail=$_GET["idOrg_detail"];
//$id_orgDetail=$_GET["id_orgDetail"];
...
if(isset($_POST['submitin'])){
	  ...
	  //$id_orgDetail=$_POST["idOrg_detail"];
	  //$prosId=$_POST['id_orgDetail'];
	//counter
	for($i=0;$i<count($projobScope);$i++){
		// condition where each item must met
		if($projobScope!="" ){
			// if all of the condition met
			mysqli_query($con, "INSERT INTO  job_scope (id_orgDetail, jobScope) VALUES('$idOrg_detail', '$projobScope[$i]')");
			//header("Location: jawatanpelaksana-jobscope.php=".$proposalId."&equipmentId=".$Idequipment);
			//header('Location:jawatanpelaksana-jobscope.php?id='.$proposalId.'&equipmentId='.$Idequipment);
			header('Location:jawatanpelaksana-jobscope.php?id='.$proposalId);
  		}else{
        ...
        <div class="container-fluid">
          ...
          <div id="page-wrapper">
           <div class="card-body">
            ...
            <div class="row">
               <div class="col-md-3 col-lg-12">
                    <div class="form-group">
                      <label class="control-label"><b>Add Job Scope for <em>Jawatankuasa Pelaksana</em></b></label>
                    </div>
                 </div>
                 
               <div class="col-lg-12">
               <div class="form-group row">
					&nbsp;&nbsp;<label class="col-form-label col-sm-2"><em>Jawatan:</em></label>
					<div class="col-sm-8">
					</div>
				</div>
                </div>
                	...
                	<form role="form" action="" method="post">
                		<div class="entry input-group">
							<div class="col-lg-12">
								...
								<div class="form-group row">
									<label for="inputjobScope" class="col-sm-2 col-form-label">Job Scope</label>
									<div class="col-sm-10">
										<input type="" name="projobScope[]" class="form-control" id="jobScope" placeholder="">
									</div>
								</div>
							</div>
            ...
            <input type="hidden" name="id_orgDetail" value="<?php echo $rowjobScope["id_orgDetail"]; ?>">	
           </div>
