...
$rowproposal=mysqli_fetch_array($queryproposal);
	...
	if(isset($_POST['submiting'])){
		...
		//$checkPostSubmit=mysqli_query($con, "SELECT * FROM proposal WHERE tujuan='$protujuan'");
		//if(mysqli_num_rows($checkPostSubmit)<=0){
		//echo "INSERT INTO proposal (tujuan, pendahuluan, objektif, penganjur, sasaran) VALUES ('$protujuan','$propendahuluan','$proobjektif','$propenganjur','$prosasaran') WHERE proposald='$proID'";
		//UPDATE proposal SET tujuan='$protujuan', pendahuluan='$propendahuluan', objekif='$proobjektif', penganjur='$propenganjur', sasaran='$prosasaran' WHERE proposald='$proID'
		//echo "UPDATE proposal SET tujuan='$protujuan', pendahuluan='$propendahuluan', objekif='$proobjektif', penganjur='$propenganjur', sasaran='$prosasaran' WHERE proposald='$proID'";
		
			mysqli_query($con, "UPDATE proposal SET tujuan='$protujuan', pendahuluan='$propendahuluan', objektif='$proobjektif', penganjur='$propenganjur', sasaran='$prosasaran' WHERE proposald='$proID'");
...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="proposal.php">Manage Proposal</a>
            <a class="collapse-item" href="../admin/activity.php">Program</a>
            <a class="collapse-item" href="../admin/equipment.php">Equipments</a>
            <a class="collapse-item" href="../admin/budget.php">Budget</a>
   ...
   <!-- PERTEKMA Committee -->
    ...
    <div id="page-wrapper">
              <?php $proposal=mysqli_query($con, "SELECT * FROM proposal WHERE iduser='$userId'");
                ...
                <div class="row">
                    <div class="col-md-3 col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea rows="3" name="protujuan" class="form-control"></textarea>
                        </div>
                    </div>
					...
					<div class="col-md-3 col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="propendahuluan" class="form-control"><?php echo $Title; ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                           <label class="control-label"><b>4.0 Tarikh dan Tempat</b></label>
                            <div class="form-group row">
                            	...
                            	<div class="col-sm-11">
                            	    <label class="col-sm-11 col-form-label" style="text-align: justify;"><?php echo date('d-m-Y',strtotime($rowproposal["date"])); ?></label>
								</div>
							</div>
                           <div class="form-group row">
                            	<label class="col-sm-1 col-form-label"><b>Tempat:</b></label>
                            	<div class="col-sm-11">
                            		<label class="col-sm-11 col-form-label" style="text-align: justify;"><?php echo $rowproposal["location"]; ?></label>
								</div>
							</div>
                        </div>
                    </div>
