...
$rowproposal=mysqli_fetch_array($queryproposal);
	...
	if(isset($_POST['submiting'])){
		 $projemputanLuar=$_POST['projemputanLuar'];
		 $projemputanDalam=$_POST['projemputanDalam'];
		 $prokolaborasi=$_POST['prokolaborasi'];
		//$proID=$_POST['proposald'];
		
		
			mysqli_query($con, "UPDATE proposal SET jemputanLuar='$projemputanLuar', jemputanDalam='$projemputanDalam', kolaborasi='$prokolaborasi' WHERE proposald='$proposalId'");
		

		header('Location:jawatanpelaksana-add.php?id='.$proposalId);
...
<head>
  ...
  <title>PERTEKMA - Manage Guest</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Guest </h1>
          </div>
                ...
                <div class="row">
                 <div class="col-md-3 col-lg-12">
                    <div class="form-group">
                      <label class="control-label"><b>9.0 Jemputan Rasmi</b></label>
                    </div>
                 </div>
