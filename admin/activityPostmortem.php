...
<head>
  ...
  <title>PERTEKMA - Activity Post-Mortem</title>
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">List of Activity Execution</h6>
					</div>
					<div class="card-body">
					  <div class="container">
						<table class="table table-bordered" width="100%" cellspacing="0">
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td>
								  <a href="activityPostmortem-view.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="View Activity Post-Mortem"></span></a>
