...
<head>
  ...
  <title>PERTEKMA - Activity Evaluation</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Activity Evaluation </h1>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center">
                <h3>PERTEKMA's Activity Evaluation Form</h3>
            </div>
        </div>
    </div>
        ...
        <div id="collapse2" class="collapse show">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <p>As a part of the postmortem process of PERTEKMA (University Malaysia Sarawak), PERTEKMA's High Council and their Main Excos are asked to submit this evaluation form. We appreciate any comments and evaluations that you would like to offer about this program and activity. Feel free to attach your comments, suggestions or descriptions. A prompt reply is requested.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-3">
                        ...
                        <div class="form-group">
                            <label class="control-label"> <?php $today = date("d/m/Y"); echo $today; ?> </label>    
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <label class="control-label">Please mark the appropriate box that best describes your ability:</label>
                        ...
                        <label class="control-label">Comments/Suggestion regarding the Activity/Task:</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <label class="control-label">I recommend this activity in the future:</label>
...
<div class="row">
    <div class="col-lg-12">
        <div class="pull-right">
            <a class="btn btn-success btn-lg" href="activityEvaluation.php?id=<?php echo $proposalId; ?>" id="btnBack"><i class="fa fa-backward"></i> Back</a>
