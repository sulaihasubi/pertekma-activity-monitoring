b<script src="../vendor/jquery/jquery.min.js"></script>
...
if(isset($_POST['add'])){
	...
	print_r($projobScope);
	$prosId=$_POST['prosId'];
	//foreach($projobScope as $singlescope){
		//mysqli_query($con, "INSERT INTO job_scope (id_orgDetail,jobScope) VALUES('$prosId','$singlescope')");
		//echo $singlescope;
		//$msgBox=alertBox('List Inserted.');
	//}
		//header('Location:activity2.php?id='.$proposalId);
}
            ...
            <div class="row">            
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">Job Scope <em>Jawatankuasa Pelaksana</em></h6>
					</div>
					<div class="container">
					  <p></p>
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td>
					  	  	  	  ...
					  	  	  	  <?php
								  $queryscope=mysqli_query($con,"SELECT * FROM job_scope WHERE id_orgDetail='$IDORG'");
								  if(mysqli_num_rows($queryscope)>0){
									  ?>
									  <a href="jawatanpelaksana-add-jobscope.php?id=<?php echo $proposalId; ?>&amp;idOrg_detail=<?php echo $col["idOrg_detail"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Job Scope Details Added"></span></a>
									  <?php
								  }else{
									  ?>
									  <a href="jawatanpelaksana-add-jobscope.php?id=<?php echo $proposalId; ?>&amp;idOrg_detail=<?php echo $col["idOrg_detail"]; ?>" class="" data-toggle="modal"><span class="btn btn-secondary btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add Job Scope Details"></span></a>
									  <?php
								  }
								  ?>
							  
								  <a href="jawatanpelaksana-view-jobscope.php?id=<?php echo $proposalId; ?>&idOrg_detail=<?php echo $col["idOrg_detail"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="View Job Scope Details"></span></a>   
							  </td>
							</tr>
  <!-- add job scope Modal-->
  <div class="modal fade" id="addJobScope<?php echo $col["idOrg_detail"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add Job Scope for <em>Jawatankuasa Pelaksana</em></h5>
        </div>
       ...
       <div class="form-group row">
		   ...
		   <div class="col-sm-10">
               ...
               <div class="d3">
                   ...
                   <input name="projobScope[]" type="text" placeholder="Write the Job Scope" class="form-control">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type="input" name="add">Save</button>
          </form>
        </div>
      </div>
    </div>
