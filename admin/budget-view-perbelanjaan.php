...
$proposalId=$_GET["id"];
	...
	if(isset($_POST['edit'])){
		  ...
		  $id_outcome=$_POST['outcomeId'];
		  $jumlah=($prohargaSeunit) * ($prokuantiti);
		
		mysqli_query($con, "update b_outcome set perkara='$properkara', hargaSeunit='$prohargaSeunit', kuantiti='$prokuantiti', jumlah='$jumlah' where outcomeId='$id_outcome'");
	}
...
if(isset($_POST['delete'])){
		...
		mysqli_query($con, "DELETE FROM b_outcome WHERE outcomeId='$id_outcome'");
...
<body id="page-top">
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">12.0 Anggaran Perbelanjaan</h6>
					</div>
					<div class="container">
					  <p></p>
						<table class="table table-bordered" id="" width="100%" cellspacing="0">
						  ...
						  <tbody>
							<?php 
							$budget=mysqli_query($con, "SELECT * FROM b_outcome WHERE Oproposald='$proposalId'");
							  while($col = mysqli_fetch_array($budget)){
								  $Title=$col["perkara"];
								  $HargaSeunit=$col["hargaSeunit"];
							...
							<tr>
							  ...
							  <td><?php echo $HargaSeunit; ?></td>
							  <td><?php echo $Kuantiti; ?></td>
							  <td><?php echo $Jumlah; ?></td>
							  <td>
							  
							  <a href="#" class="" data-toggle="modal" data-target="#editDetails<?php echo $col["outcomeId"]; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Details"></span></a>
							  
							   <a href="#" class="" data-toggle="modal" data-target="#deleteDetails<?php echo $col["outcomeId"]; ?>"><span class="btn btn-danger btn-xs fa fa-trash-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Details"></span></a>
							  </td>
							</tr>
							
  <!--Edit anggaran perbelanjaan Modal-->
  <div class="modal fade" id="editDetails<?php echo $col["outcomeId"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-header">
       ...
       <form method="post" action="">
           ...
           <div class="form-group row">
		   		<label class="col-form-label col-sm-2">Perkara:</label>
		   		<div class="col-sm-10">
		   			<input type="text" name="properkara" class="form-control" value="<?php echo $Title; ?>">
		   		</div>
		   </div>	

           <div class="form-group row">
		   		<label class="col-form-label col-sm-2">Harga Seunit:</label>
		   		<div class="col-sm-8">
		   			<input type="text" name="prohargaSeunit" class="form-control" value="<?php echo $HargaSeunit; ?>">
		   		</div>
		   </div>	
		  ...
		  <input type="hidden" name="outcomeId" value="<?php echo $col["outcomeId"]; ?>">
		  </div>
  ...
  <!--Delete anggaran pendapatan-->
  <div class="modal fade" id="deleteDetails<?php echo $col["outcomeId"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
       ...
       <form method="post" action="">
           ...
           <div class="form-group row">
		   		<label class="col-form-label col-sm-2">Harga Seunit:</label>
		   		<div class="col-sm-8">
		   		<label class="col-form-label col-sm-10"><?php echo $HargaSeunit; ?></label>
		   		</div>
		   </div>	
           ...
           <div class="form-group row">
		   		<label class="col-form-label col-sm-2">Kuantiti:</label>
		   		<div class="col-sm-10">
		   		<label class="col-form-label col-sm-10"><?php echo $Kuantiti; ?></label>
		   		</div>
		   </div> 
		        
		  <input type="hidden" name="userId" value="<?php echo $session; ?>">
		  <input type="hidden" name="id_outcome" value="<?php echo $col["outcomeId"]; ?>">
		  </div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <button class="btn btn-primary" type="delete" name="delete">Delete</button>
						  ...
						  <tfoot>
							<tr>
								...
								<th>
									<?php
									$Totalquery=mysqli_query($con, "SELECT SUM(jumlah) AS Total FROM b_outcome WHERE Oproposald='$proposalId'");
									$row1=mysqli_fetch_array($Totalquery);
									echo $row1["Total"];
									?>
								</th>
							</tr>
