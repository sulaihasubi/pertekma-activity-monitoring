            ...
            <div class="row">
                ...
                <div class="row">
					...
					<div class="col-md-3 col-lg-12">
                        ...
                        <div class="form-group">
                            <label class="control-label">Sokongan dan Ulasan Timbalan Naib Canselor, Hal Ehwal Pelajar dan Alumni</label>
                        </div>
                        <div class="form-group">
                        <label class="control-label">____________________________________________________________________________________________________________________________________________________________</label>
                        </div>
...
<div class="row">
    <div class="col-lg-12">
        <div style="float: right;">
             <a class="btn btn-success btn-lg" href="proposal.php?id=<?php echo $proposalId; ?>" id="btnBack"><i class="fa fa-backward"></i> Back</a>
