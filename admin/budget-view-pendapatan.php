...
$proposalId=$_GET["id"];
	...
	if(isset($_POST['edit'])){
		...
		mysqli_query($con, "update b_income set perkara='$properkara', hargaSeunit='$prohargaSeunit', kuantiti='$prokuantiti', jumlah='$jumlah' where incomeId='$id_income'");
...
if(isset($_POST['delete'])){
		...
		mysqli_query($con, "DELETE FROM b_income WHERE incomeId='$id_income'");
...
<body id="page-top">
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">12.0 Anggaran Pendapatan</h6>
					</div>
					<div class="container">
					  <p></p>
						<table class="table table-bordered" id="" width="100%" cellspacing="0">
						  ...
						  <tbody>
							<?php 
							$budget=mysqli_query($con, "SELECT * FROM b_income WHERE Iproposald='$proposalId'");
							...
							<tr>
							  ...
							  <td>
							  <a href="#" class="" data-toggle="modal" data-target="#editDetails<?php echo $col["incomeId"]; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Details"></span></a>
							  
							  <a href="#" class="" data-toggle="modal" data-target="#deleteDetails<?php echo $col["incomeId"]; ?>"><span class="btn btn-danger btn-xs fa fa-trash-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Details"></span></a>
							  </td>
							</tr>
							
  <!--Edit anggaran pendapatan-->
  <div class="modal fade" id="editDetails<?php echo $col["incomeId"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-header">
       ...
       <form method="post" action="">
		  ...
		  <input type="hidden" name="id_income" value="<?php echo $col["incomeId"]; ?>">
		  </div>
  ...
  <div class="modal fade" id="deleteDetails<?php echo $col["incomeId"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
          ...
          <button class="btn btn-primary" type="delete" name="delete">Delete</button>
						  ...
						  <tfoot>
							<tr>
								...
								<th>
									<?php
									$Totalquery=mysqli_query($con, "SELECT SUM(jumlah) AS Total FROM b_income WHERE Iproposald='$proposalId'");
