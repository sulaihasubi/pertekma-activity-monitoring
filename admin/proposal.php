...
// Insert query for edit proposal
	if(isset($_POST['edit'])){
		//$protitle=$_POST['protitle'];
		//$protime=$_POST['protime1'];
		//$changetime1=date("Y-m-d H:i:s", strtotime($protime));
		//$prodate=$_POST['prodate1'];
		//$changeformat1=date('Y-m-d',strtotime($prodate));
		//$prolocation=$_POST['prolocation'];
		//$userId=$_POST['userId'];
		//$proaction=$_POST['proaction'];	
		...
		//if(mysqli_num_rows($checkProposalDuplicate)<=0){
			...
			mysqli_query($con, "UPDATE proposal SET proposalTitle='$protitle', date1='$prodate1', date2='$prodate2', time_1='$protime_1', time_2='$protime_2', location='$prolocation', AcaSession='$proAcaSession'  WHERE proposald='$proposalId'");
			$msgBox=alertBox('Proposal Updated!');
		//}else{
			//$msgBox=alertBox('Similar proposal added. Please check title.');
		//}
	}
//Query delete proposal
	if(isset($_POST['delete'])){	
		  ...
		  //$prolocation=$_POST['prolocation'];
			...
			mysqli_query($con, "DELETE FROM proposal WHERE proposald='$proposalId'");
				$msgBox=alertBox('Proposal Successfully Deleted!');
	}
?>
						...
						<table class="table table-bordered" width="100%" cellspacing="0">
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td><?php echo $date1; ?> &nbsp to <?php echo $date2; ?></td>
							  <td><?php echo $time_1; ?> &nbsp to <?php echo $time_2; ?></td>
							  <td><?php echo $Location; ?></td>
							  <td>
							  
							  <?php
								  $querycheckexist=mysqli_query($con, "SELECT * FROM org_detail WHERE id_proposal='$idpro'");
								  $row3=mysqli_num_rows($querycheckexist);
								  if($row3<=0){
									  //no data insert
									  ?>
								  	<a href="proposal-add.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-secondary btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Jawatankuasa Pelaksana Assigned"></span></a>
								  	<?php
								  }else{
									  //have data insert
									  ?>
								  	<a href="proposal-add.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Jawatankuasa Pelaksana Not Assigned Yet"></span></a>
								  	<?php
								  }
							?>
								  
								  <a href="#" class="" data-toggle="modal" data-target="#editProposal<?php echo $col["proposald"]; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Proposal"></span></a>
								  
								  <a href="pr.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="View Proposal"></span></a>
								  
								  <a href="#" class="" data-toggle="modal" data-target="#deleteProposal<?php echo $col["proposald"]; ?>"><span class="btn btn-danger btn-xs fa fa-trash-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Proposal"></span></a>
