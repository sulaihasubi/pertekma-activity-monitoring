...
$rowproposal=mysqli_fetch_array($queryproposal);
	...
	if(isset($_POST['submiting'])){
		...
		header('Location:proposal-add.php?id='.$proposalId);
                ...
                <div class="row">
                 <div class="col-md-3 col-lg-12">
                    <div class="form-group">
						<?php $queryPenutup=mysqli_query($con, "SELECT * FROM proposal WHERE proposald='$proposalId'");
								$rowpenutup=mysqli_fetch_array($queryPenutup);?>
                      <label class="control-label"><b>13.0 Penutup</b></label>
                      <textarea rows="8" name="propenutup" class="form-control"><?php echo $rowpenutup["penutup"]; ?></textarea>
                    </div>
                 </div>
...
<div class="row">
    <div class="col-lg-12">
        <div style="float: right;">
             ...
             <button name="submiting" class="btn btn-success btn-lg"><i class="fa fa-save"></i> Update</button>
