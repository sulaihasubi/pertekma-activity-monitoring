...
// Query for Accept proposal by TNC
	if(isset($_POST['accept'])){	
		  ...
		  $userId=$_POST['userId'];	
		  $statusproposal=$_POST['proposalStatus'];
		  //$protitle=$_POST['protitle'];
		  //$prodate1=$_POST['prodate1'];
		  //$prodate2=$_POST['prodate2'];		
		  //$protime_1=$_POST['protime_1'];
		...
		//if(mysqli_num_rows($checkProposalDuplicate)<=0){
			...
			mysqli_query($con, "UPDATE proposal SET proposalStatus='1' WHERE proposald='$proposalId'");
...
// Query for Decline proposal by TNC
	if(isset($_POST['decline'])){	
		  ...
		  //$prolocation=$_POST['prolocation'];
			...
			mysqli_query($con, "UPDATE proposal SET proposalStatus='0' WHERE proposald='$proposalId'");
						...
						<table class="table table-bordered" width="100%" cellspacing="0">
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td>
							  	 <a href="proposal-tncview.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Read Details"></span></a>
							    
						  		<?php
								  if($statusproposal==1){
									  ?>
									  <button name="accept" class="btn btn-success btn-group-sm"><i class="fa fa-save"></i> Accept</button>
									  <?php
								  }elseif($statusproposal==0){
									  ?>
									  <button name="decline" class="btn btn-danger btn-group-sm"><i class="fa fa-save"></i> Decline</button>
								  	<?php
								  }
								  ?>
