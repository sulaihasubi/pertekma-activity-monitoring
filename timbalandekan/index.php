...
$queryCountProposal=mysqli_query($con,"SELECT COUNT(*) CountProposal FROM proposal WHERE proposalStatus=0");
$row1=mysqli_fetch_array($queryCountProposal);
$numCountProposal=$row1["CountProposal"];

//count accapted proposal
$queryCountProposal1=mysqli_query($con,"SELECT COUNT(*) CountProposal1 FROM proposal WHERE proposalStatus=1");
...
//count number of accepted proposal for Timbalan Dekan Page (update academicSession)
