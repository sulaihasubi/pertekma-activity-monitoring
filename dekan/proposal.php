...
// Query for Accept proposal by TNC
	if(isset($_POST['accept'])){	
		...
		//if(mysqli_num_rows($checkProposalDuplicate)<=0){
			...
			mysqli_query($con, "UPDATE proposal SET proposalStatus2='1' WHERE proposald='$idsproposal'");
...
// Query for Decline proposal by TNC
	if(isset($_POST['decline'])){	
		  ...
		  //$prolocation=$_POST['prolocation'];
			...
			mysqli_query($con, "UPDATE proposal SET proposalStatus2='2' WHERE proposald='$idsproposal'");
						  ...
						  <tbody>
							...
							$proposal=mysqli_query($con, "SELECT * FROM proposal ORDER BY proposald DESC");
							  while($col = mysqli_fetch_array($proposal)){
								  ...
								  $idpro=$col["proposald"];
								  $AcaSession=$col["AcaSession"];
								  $statusproposal2=$col["proposalStatus2"];	 
							?>
							...
							<tr>
							  ...
							  <td>
							  	 <a href="proposal-dekanview.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Read Details"></span></a>
							    
						  		<?php
								  if($statusproposal2==1){
									  ?>
