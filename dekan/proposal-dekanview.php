...
if($rowproposal["tujuan"]!=NULL or $rowproposal["pendahuluan"]!=NULL){
	...
	// Insert query form TNC Comment into db
	if(isset($_POST['submiting'])){
		 ...
		 $dekan_comment=$_POST['dekan_comment'];
		...
		//echo "UPDATE proposal SET tujuan='$protujuan', pendahuluan='$propendahuluan', objektif='$proobjektif', penganjur='$propenganjur', sasaran='$prosasaran' WHERE proposald='$proID'";
			mysqli_query($con, "UPDATE proposal SET dekan_comment='$dekan_comment' WHERE proposald='$proposalId'");
...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <!-- PERTEKMA Committee -->
    ...
    <div class="row">
							<div class="col-lg-12">
							<?php $queryproposal=mysqli_query($con, "SELECT * FROM proposal WHERE proposald='$proposalId'"); 
								$col = mysqli_fetch_array($queryproposal);
								$Title=$col["proposalTitle"];
								?>
								<div class="text-center">
									<h3> <?php echo $Title=$col["proposalTitle"]; ?></h3>
								</div>
							</div>
						</div>
    <div id="page-wrapper">
              <?php $proposal=mysqli_query($con, "SELECT * FROM proposal WHERE proposald='$proposalId'");
                        ...
                        <div class="form-group">
                           <label class="h3 mb-0 text-gray-800"><h4>4.0 Tarikh dan Tempat</h4></label>
                            <div class="form-group row">
                            	<label class="col-sm-12 col-form-label"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tarikh:</b>&nbsp;<?php echo $col["date1"]; ?>&nbsp;hingga&nbsp;<?php echo $date2; ?></label>
							</div>
                           <div class="form-group row">
                            	<label class="col-sm-12 col-form-label"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tempat:</b>&nbsp;<?php echo $Location; ?></label>
								</div>
							</div>
                        </div>
                    </div>
                   ...
                   <div class="col-md-3 col-lg-12">
                    ...
                    <div class="col-md-3 col-lg-12">
                        <div class="form-group">
							...
							<label class="col-sm-12 col-form-label" style="text-align: justify;"><?php
								$jemLuar=$row1["jemputanLuar"];
								$alljemLuar=explode("\n",$jemLuar);
								foreach($alljemLuar as $sinjemLuar){
									echo $sinjemLuar."<br>";
								}
								?></label>
                        </div>
                    ...
                    <div class="col-md-3 col-lg-12">
                        <div class="form-group">
							...
							<label class="col-sm-12 col-form-label" style="text-align: justify;"><?php
								$jemDalam=$row1["jemputanDalam"];
								$alljemDalam=explode("\n",$jemDalam);
								foreach($alljemDalam as $sinjemDalam){
									echo $sinjemDalam."<br>";
								}
								?></label>
					...
					<div class="col-md-3 col-lg-12">
                        <div class="form-group">
							...
							<label class="col-sm-12 col-form-label" style="text-align: justify;"><?php
								$jemkola=$row1["kolaborasi"];
								$alljemkola=explode("\n",$jemkola);
								foreach($alljemkola as $sinjemKola){
									echo $sinjemKola."<br>";
								}
								?></label>
               ...
               <div class="col-md-3 col-lg-12">
           			...
           			<div class="col-md-3 col-lg-12">
                       <?php $queryProposa11=mysqli_query($con, "SELECT * FROM proposal WHERE proposald='$proposalId'");
								$row11=mysqli_fetch_array($queryProposa11);?>
                        <div class="form-group">
                            <label class="h3 mb-0 text-gray-800"><h4>13.0 Penutup</h4></label>
                            <div class="col-sm-12">
                            	<label class="col-sm-12 col-form-label" style="text-align: justify;"><?php echo $row11["penutup"]; ?></label>
							</div>
                        </div>
                    </div>
            		...
            		&nbsp;&nbsp;&nbsp;
           			...
           			<div class="col-md-3 col-lg-12">
                        <div class="form-group">
                            <label class="control-label"><b>Sokongan dan Ulasan Timbalan Dekan Fakulti Sains Komputer dan Teknologi Maklumat</b></label>
                            <textarea rows="6" name="dekan_comment" class="form-control"><?php echo $row1["dekan_comment"]; ?></textarea>
		...
		<div class="col-lg-12">
			<div style="float: right;">
				<a class="btn btn-success btn-lg" href="proposal.php" id="btnBack"><i class="fa fa-backward"></i> Back</a>
