...
// Query for Decline proposal by TNC
	if(isset($_POST['decline'])){	
		  ...
		  //$prolocation=$_POST['prolocation'];
			...
			mysqli_query($con, "UPDATE proposal SET proposalStatus='0' WHERE proposald='$idsproposal'");
						...
						<table class="table table-bordered" width="100%" cellspacing="0">
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td>
							  	 <a href="proposal-tncview.php?id=<?php echo $col["proposald"]; ?>" class="" data-toggle="modal"><span class="btn btn-secondary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Read Details"></span></a>
							  	 
							  	 <a href="#" class="" data-toggle="modal" data-target="#acceptProposal<?php echo $col["proposald"]; ?>"><span class="btn btn-primary btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Accept Proposal"></span></a>
							  	 
							  	 <a href="#" class="" data-toggle="modal" data-target="#declineProposal<?php echo $col["proposald"]; ?>"><span class="btn btn-danger btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Decline Proposal"></span></a>
...
<!-- Accept Proposal Modal-->
  <div class="modal fade" id="acceptProposal<?php echo $col["proposald"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Accept this Proposal?</h5>
        </div>
        <div class="modal-body">
       <form method="post" action="">
           				<div class="form-group row">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <button class="btn btn-primary" type="delete" name="delete">Accept</button>
          </form>
        </div>
      </div>
    </div>
