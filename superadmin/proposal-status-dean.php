      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Proposal Status Monitoring</h1>
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">Proposal Approval Supported by Dean</h6>
					</div>
					<div class="card-body">
					  <div class="container">
						<table class="table table-bordered" 
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td><?php echo $dekan_comment; ?></td>
							  <td><?php if($proposalStatus2==1){echo "Accepted"; }elseif($proposalStatus2==0){echo "Pending";}elseif($proposalStatus2==2){echo "Declined";} ?></td>
       ...
       <form method="post" action="">
		...
		<div class="col-lg-12">
			<div style="float: right;">
				<a class="btn btn-success btn-lg" href="proposal-status.php" id="btnBack"><i class="fa fa-backward"></i> Back</a>
