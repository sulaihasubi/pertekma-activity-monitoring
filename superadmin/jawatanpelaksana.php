...
if(isset($_POST['submitting'])){
	...
	mysqli_query($con, "INSERT INTO org_detail ( id_proposal, nama, ja_watan) VALUES('$proposalId','$combinename','$proja_watan')");
...
if(isset($_POST['edit'])){
	...
	mysqli_query($con, "UPDATE org_detail SET nama='$combinename', ja_watan='$proja_watan' WHERE idOrg_detail='$idOrg_detail'");
	foreach($pronama as $nama){
			$checkExistMember=mysqli_query($con, "SELECT * FROM org_name WHERE nama='$nama'");
			if(mysqli_num_rows($checkExistMember)<=0){
				mysqli_query($con,"INSERT INTO org_name (nama) VALUES ('$nama')");
					...
					<div class="container">
					  <p></p>
						<table class="table table-bordered"  width="100%" cellspacing="0">
						  <thead>
							<tr>
							  <th width="30%">Jawatankuasa Pelaksana</th>
							  <th>Nama</th>
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td style="text-align: justify;"><?php 
								  ...
								  ?></td>
							  <td>
								  <a href="#" class="" data-toggle="modal" data-target="#editCommittee<?php echo $col["idOrg_detail"]; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Details "></span></a>
...
<!--Delete Committee Modal-->
  <div class="modal fade" id="deleteCommittee<?php echo $col["idOrg_detail"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Delete Jawatankuasa Pelaksana</h5>
        </div>
        <div class="modal-body">
       <form method="post" action="">
       ...
       <div class="form-group row">
		...
		<div class="col-lg-12">
			<div style="float: right;">
				...
				<a class="btn btn-success btn-lg" href="jawatanpelaksana-jobscope.php?id=<?php echo $proposalId; ?>" id="btnNext"><i class="fa fa-save"></i> Next</a>
