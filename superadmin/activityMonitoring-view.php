...
//$username=$_POST['id_activitymonitoring'];
      ...
      <div id="content">
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">List of <em>Jawatankuasa Pelaksana</em></h6>
					</div>
					<div class="container">
				  		<p></p>
						  ...
						  <tbody>
							...
							<tr>
							  ...
							  <td style="text-align: justify;"><?php 
								  ...
								  ?></td>
							  <td>
								  <a href="activityMonitoring-list-view.php?id=<?php echo $proposalId; ?>&amp;username=<?php echo $Jawatan; ?>" data-toggle="modal"><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Monitor Activity Job Scope & Activity Log"></span></a>
		...
		<div class="col-lg-12">
			<div style="float: right;">
				<a class="btn btn-success btn-lg" href="activityMonitoring.php" id="btnBack"><i class="fa fa-backward"></i> Back</a>
