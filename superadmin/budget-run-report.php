...
$proposalId=$_GET["id"];
	...
	if(isset($_POST['edit'])){
		  ...
		  $id_income=$_POST['incomeId'];
		
		mysqli_query($con, "update b_income set perkara='$properkara', hargaSeunit='$prohargaSeunit', kuantiti='$prokuantiti' where incomeId='$id_income'");
	}
?>
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">Anggaran Pendapatan</h6>
					</div>
					<div class="container">
					  <p></p>
...
<div id="page-wrapper">
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
            		<div class="card shadow mb-4">
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">Anggaran Perbelanjaan</h6>
					</div>
					<div class="container">
					  <p></p>
						<table class="table table-bordered" id="" width="100%" cellspacing="0">
