...
if(isset($_POST['delete'])){
	...
	$jobscope_id=$_POST['jobscope_id'];
	
	mysqli_query($con, "DELETE FROM org_detail WHERE idOrg_detail='$idOrg_detail'");
	mysqli_query($con, "DELETE FROM job_scope WHERE jobscope_id='$jobscope_id'");
    ...
    <div id="largeModal" class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-header">
       ...
       <div class="form-group row">
		  ...
		  <input type="hidden" name="jobscope_id" value="<?php echo $col["jobscope_id"]; ?>">
		  </div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
