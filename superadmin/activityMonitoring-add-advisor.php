...
if(isset($_POST['submiting'])){
	...
	for($i=0;$i<count($prologdetail);$i++){
		...
		if($prodate!="" && $prologdetail[$i]!=""){
			...
			header('Location:activityMonitoring-advisor-view.php?id='.$proposalId.'&username='.$Jawatan);
  		}else{
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary"><?php $queryExco=mysqli_query($con, "SELECT * FROM activityMonitoring WHERE id_proposal='$proposalId'");
						$rowUsername=mysqli_fetch_array($queryExco);
						echo $rowUsername["username"];
						?></h6>
					</div>
					<div class="card-body">
					  <div class="container">
