...
$proposalId=$_GET["id"];
$user=$_GET["user"];
$queryOne=mysqli_query($con, "SELECT * FROM org_detail WHERE id_proposal='$proposalId' AND ja_watan='$user'");
$row1=mysqli_fetch_array($queryOne);
            ...
            <div class="row">
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  <h6 class="m-0 font-weight-bold text-primary">Manage Activity:</h6>
					</div>
					<div class="card-body">
					  <div class="table-responsive">
						  ...
						  <tbody>
							<tr>
							  <td><strong>fggf Activity Execution</strong></td>
							  <td>								  
								   <a href="activity-JobScope.php?id=<?php echo $proposalId; ?>&idOrg_detail=<?php echo $row1["idOrg_detail"]; ?>" class=""><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update Details"></span></a>
							  </td>
							</tr>
							<tr>
							  <td><strong>fgfg Activity Log</strong></td>
							  <td>
							  									  
								  <a href="activityMonitoring-add-advisor.php?id=<?php echo $proposalId; ?>&user=<?php echo $user; ?>" class=""><span class="btn btn-primary btn-xs fa fa-window-maximize" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update Details"></span></a>
							  </td>
							</tr>
						  </tbody>
						</table>				  
