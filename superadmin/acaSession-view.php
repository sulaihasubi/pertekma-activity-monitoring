...
//$idacaDetail=$_GET["idacadetail"];

//Query for edit details
	if(isset($_POST['edit']))
	{
		$proacaName=$_POST['proacaName'];
		$proacaJawatan=$_POST['proacaJawatan'];
		$proacaNoMatric=$_POST['proacaNoMatric'];
		$proacanoTel=$_POST['proacanoTel'];
		//$userId=$_POST['userId'];
		$idacadetail=$_POST["idacaDetail"];

			mysqli_query($con, "UPDATE acadetail SET acaName='$proacaName', acaJawatan='$proacaJawatan', acaNoMatric='$proacaNoMatric', acanoTel='$proacanoTel' WHERE idacaDetail='$idacadetail'");
			$msgBox=alertBox('Details Updated.');
	}

//Query for delete details
	if(isset($_POST['delete']))
	{
		...
		$idacadetail=$_POST["idacaDetail"];
			...
			mysqli_query($con, "DELETE FROM acadetail WHERE idacaDetail='$idacadetail'");
			$msgBox=alertBox('Details Deleted.');
	}
?>
...
<head>
  ...
  <title>PERTEKMA - Committee Batch</title>
            	...
            	<?php if($msgBox){ echo $msgBox; } ?>
					...
					<div class="card-header py-3">
					  ...
					  <h6 class="m-0 font-weight-bold text-primary">
							PERSATUAN TEKNOLOGI MAKLUMAT (<?php $queryPertekma=mysqli_query($con, "SELECT * FROM academicsession WHERE acaSessionId='$acaSessionId'");
						$rowPertekma=mysqli_fetch_array($queryPertekma);
					  ...
					  <p></p>
						<table class="table table-bordered"  width="100%" cellspacing="0">
						  ...
						  <tbody>
							...
							<?php 
							$acadetail=mysqli_query($con, "SELECT * FROM acadetail WHERE idacaSession='$acaSessionId'");
							  while($col = mysqli_fetch_array($acadetail)){
								  $Bil=$col["idacaDetail"];
								  $Nama=$col["acaName"];
								  $Jawatan=$col["acaJawatan"];
								  $NoMatric=$col["acaNoMatric"];
								  $NoTel=$col["acanoTel"];
							?>
							<tr>
							  ...
							  <td>
								  <a href="#" class="" data-toggle="modal" data-target="#editList<?php echo $Bil; ?>"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Detail"></span></a>
								  
								   <a href="#" class="" data-toggle="modal" data-target="#deleteList<?php echo $Bil; ?>"><span class="btn btn-danger btn-xs fa fa-trash-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete Detail"></span></a>
								  
							  </td>
							</tr>
							
<!-- Edit Academic Session Modal-->
  <div class="modal fade" id="editList<?php echo $col["idacaDetail"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div id="largeModal" class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-header">
       ...
       <form method="post" action="">
		   ...
		   <div class="col-sm-10">
		   	<input type="text" name="proacaName" class="form-control" value="<?php echo $Nama; ?>">
		   </div>
		   </div>
		   ...
		   <div class="col-sm-10">
		   	<input type="text" name="proacaJawatan" class="form-control" value="<?php echo $Jawatan; ?>">
		   </div>
		   </div>
		   
		   <div class="form-group row">
		   <label class="col-form-label col-sm-2">No. Matrik:</label>
		   <div class="col-sm-10">
		   	<input type="text" name="proacaNoMatric" class="form-control" value="<?php echo $NoMatric; ?>">
		   </div>
		   </div>

		   
		   <div class="form-group row">
		   <label class="col-form-label col-sm-2">No. Tel:</label>
		   <div class="col-sm-10">
		   	<input type="text" name="proacanoTel" class="form-control" value="<?php echo $NoTel; ?>">
		   </div>
		   </div>
...
<!-- Delete Details Modal-->
  <div class="modal fade" id="deleteList<?php echo $col["idacaDetail"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div id="largeModal" class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
       ...
       <form method="post" action="">
		   ...
		   <label class="col-form-label col-sm-2">Nama:</label>
		   <div class="col-sm-10">
		   <label class="col-form-label col-sm-10"><?php echo $Nama; ?></label>
		   </div>
		   </div>
		   ...
		   <label class="col-form-label col-sm-2">No. Matrik:</label>
		   <div class="col-sm-10">
		   <label class="col-form-label col-sm-10"><?php echo $NoMatric; ?></label>
		   </div>
		   </div>
		   ...
		   <label class="col-form-label col-sm-2">No. Tel:</label>
		   <div class="col-sm-10">
		   <label class="col-form-label col-sm-10"><?php echo $NoTel; ?></label>
		   </div>
		   </div>
  ...
  <div class="modal fade" id="newCommittee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Jawatankusa Pelaksana</h5>
        </div>
        <div class="modal-body">
       <form method="post" action="">
       <div class="form-group row">
