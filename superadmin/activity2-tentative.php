...
<body id="page-top">
							...
							<tr>
							  ...
							  <td><?php 
								  ...
								  if($row3<=0){
									  //date not update
									  ?>
								  	<a href="activity-add2.php?id=<?php echo $proposalId; ?>&amp;idprogram=<?php echo $col["programId"]; ?>" class="" data-toggle="modal"><span class="btn btn-success btn-xs fa fa-plus-square" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add Details Program Tentative"></span></a>
								  	<?php
								  }else{
									  //date updated
									  ?>
 ...
 <div class="modal-dialog" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tentatif Program</h5>
        </div>
        <div class="modal-body">
       <form method="post" action="">
