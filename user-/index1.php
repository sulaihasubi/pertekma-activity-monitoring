...
$queryCountProposal=mysqli_query($con,"SELECT COUNT(*) CountProposal FROM proposal");
...
while($row4=mysqli_fetch_array($queryAllProposal)){
	...
	while($row5=mysqli_fetch_array($queryCountAcaSession)){
		...
		mysqli_query($con,"UPDATE academicsession SET totalProposal='$targetProposal' WHERE acaSession='$Proposal'");
	}
}
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Sub-Activity</div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <!--<div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Activity Proposal Progress Bar</h6>
                </div>
                <div class="card-body">
                 <?php
					...
					while($row14=mysqli_fetch_array($querycalPercent)){
						...
						$Sum=(($calPro+$calAct+$calInc+$calOut+$calEqu+$calProg)/22)*100;
						$RoundSum=round($Sum);
						if(0<=$RoundSum && $RoundSum<20){
							...
							<h4 class="small font-weight-bold"><?php echo $proosaltitle; ?> <span class="float-right"><?php echo $RoundSum; ?>%</span></h4>
						  	<div class="progress mb-4">
								<div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo $RoundSum; ?>%" aria-valuenow="<?php echo $RoundSum; ?>" aria-valuemin="0" aria-valuemax="100"></div>
						  	</div>
							<?php
							...
							<h4 class="small font-weight-bold"><?php echo $proosaltitle; ?> <span class="float-right"><?php echo $RoundSum; ?>%</span></h4>
						  	<div class="progress mb-4">
								<div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo $RoundSum; ?>%" aria-valuenow="<?php echo $RoundSum; ?>" aria-valuemin="0" aria-valuemax="100"></div>
						  	</div>
							<?php
							...
							<h4 class="small font-weight-bold"><?php echo $proosaltitle; ?> <span class="float-right"><?php echo $RoundSum; ?>%</span></h4>
						  	<div class="progress mb-4">
								<div class="progress-bar" role="progressbar" style="width: <?php echo $RoundSum; ?>%" aria-valuenow="<?php echo $RoundSum; ?>" aria-valuemin="0" aria-valuemax="100"></div>
						  	</div>
							<?php
							...
							<h4 class="small font-weight-bold"><?php echo $proosaltitle; ?> <span class="float-right"><?php echo $RoundSum; ?>%</span></h4>
						  	<div class="progress mb-4">
								<div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $RoundSum; ?>%" aria-valuenow="<?php echo $RoundSum; ?>" aria-valuemin="0" aria-valuemax="100"></div>
						  	</div>
							<?php
							...
							<h4 class="small font-weight-bold"><?php echo $proosaltitle; ?> <span class="float-right"><?php echo $RoundSum; ?>%</span></h4>
                  			<div class="progress">
                    			<div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $RoundSum; ?>%" aria-valuenow="<?php echo $RoundSum; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                  			</div>
							<?php
						}
					}
